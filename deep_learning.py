...
conf = (SparkConf()
         .setMaster("local")
         .setAppName("Deep Learning")
         .set("spark.executor.memory", "1g"))
sc = SparkContext(conf = conf)

# A test for Spark and TensorFlow
...
test_data = extract_data(test_data_filename, 3000)
test_labels = extract_labels(test_labels_filename, 3000)
